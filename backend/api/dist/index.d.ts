...
import express__default, * as express from 'express';
...
declare const appRouter: _trpc_server.CreateRouterInner<
    ...
    {
        property: _trpc_server.CreateRouterInner<
            _trpc_server.RootConfig<{
                ctx: {
                    req: express__default.Request<
                        express_serve_static_core.ParamsDictionary,
            ...
            {
                getProperties: _trpc_server.BuildProcedure<
                    'query',
                    {
                ...
                >;
                createProperty: _trpc_server.BuildProcedure<
                    'mutation',
                    {
                        _config: _trpc_server.RootConfig<{
                            ctx: {
                ...
                >;
                deleteProperty: _trpc_server.BuildProcedure<
                    'mutation',
                    {
                        _config: _trpc_server.RootConfig<{
                            ctx: {
                ...
                >;
                getTags: _trpc_server.BuildProcedure<
                    'query',
                    {
                        _config: _trpc_server.RootConfig<{
                            ctx: {
                ...
                >;
                createTag: _trpc_server.BuildProcedure<
                    'mutation',
                    {
                        _config: _trpc_server.RootConfig<{
                            ctx: {
                ...
                >;
                deleteTag: _trpc_server.BuildProcedure<
                    'mutation',
                    {
                        _config: _trpc_server.RootConfig<{
                            ctx: {
