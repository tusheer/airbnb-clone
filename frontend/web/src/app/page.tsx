                        ...
                        <div className="flex items-center justify-between gap-4 rounded-xl border p-4 sm:col-[1/-1] xl:col-[2/-2] 2xl:col-[3/-3]">
                            ...
                            <div>
                                <label className="switch">
                                    <input type="checkbox" name="check" className="togggleinput" />
        ...
        <div className="">
            ...
            <div>
                <div className="mt-4 flex items-center justify-between">
                    <h3 className="text-dark-gray text-sm font-semibold">Torino, Italy</h3>
                    <span className="flex items-center gap-2">
                        ...
                        <span className="text-dark-gray text-sm"> 4.87 ·</span>
                    </span>
                </div>
                <div className="text-dark-gray mt-1 flex flex-col text-justify text-[15px]">
                    {' '}
                    <span>Stay with Carmela,Hosting for 7 years</span>
                    <span>5 nights ,Sep 14 – 19</span>
                </div>
                <a className="text-dark-gray mt-2 text-[15px] underline ">
