                                ...
                                <AnimatePresence>
                                    {selectedSearchArea === 'where' ? (
                                        <motion.div
                                            ...
                                            className="absolute left-2  top-[75px] w-[478px] max-w-3xl rounded-[30px] border border-gray-200 bg-white px-8 py-9"
                                        >
                                            ...
                                            <div className="grid grid-cols-3 gap-x-4 gap-y-8 ">
                                                {regions.map((_region) => (
                                                    ...
                                                    >
                                                        <div
                                                            className={`h-[122px] overflow-hidden rounded-xl border border-gray-200 hover:border-gray-500 ${
                                                                _region.key === 'all' && !region
                                                                    ? 'border-gray-500'
                                                                    : ''
                                                            } ${_region.key === region ? 'border-gray-500' : ''}`}
                                                        >
                                                            <img src={_region.image} alt={_region.name} />
                                                        </div>
                                                        <span className="text-sm text-gray-600 ">{_region.name}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </motion.div>
                                ...
                                <AnimatePresence initial={false}>
                                    {openSearch ? (
                                        ...
                                        <motion.div
                                            ...
                                            className="i1box flex h-12 cursor-pointer select-none items-center overflow-hidden"
                                        >
